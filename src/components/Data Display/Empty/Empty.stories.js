...
import EmptyBasic from './EmptyBasic';
import PropTypes from 'prop-types';

export default {
    component: EmptyBasic, //해당 컴포넌트
    title: "Data Display/Empty", //Storybook 앱의 사이드바에서 컴포넌트를 참조하는 방법
...
const EmptyTemplate = (args) => <EmptyBasic {...args} />;

export const Basic = EmptyTemplate.bind({});
Basic.args = {
    image: 'CUSTOM_IMAGE',
    imageStyle: {
        height: 60,

...
import StepsBasic from './StepsBasic';
import PropTypes from 'prop-types';

export default {
    component: StepsBasic, //해당 컴포넌트
    title: "Navigation/Steps", //Storybook 앱의 사이드바에서 컴포넌트를 참조하는 방법
...
const StepsTemplate = (args) => <StepsBasic {...args} />;

export const Basic = StepsTemplate.bind({});
Basic.args = {
}
